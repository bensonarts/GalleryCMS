...
class Feed extends MY_Controller
{
  ...
  {
    $rs = $this->feed_model->fetch_by_user_id();
  ...
  {
    echo $this->_alpha_id(9007199254740989, FALSE, TRUE, 'd7uJEWuvud8ucru!apHEbreJa6rE#hA$');
  }
   ...
   */
  private function _alpha_id($in, $to_num = false, $pad_up = false, $passKey = null)
  {
